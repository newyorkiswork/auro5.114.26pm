...
const sidebarVariants = cva("fixed inset-y-0 z-30 flex flex-col bg-sidebar-background text-sidebar-foreground", {
  variants: {
    position: {
...
const Sidebar = React.forwardRef<HTMLDivElement, SidebarProps>(
  ({ className, position, size, open = true, onOpenChange, children, ...props }, ref) => {
...
const SidebarFooter = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("flex h-14 items-center border-t border-sidebar-border px-4", className)} {...props} />
  ),
)
...
>(({ className, sidebarOpen, ...props }, ref) => (
  <button
    ref={ref}
    className={cn(
